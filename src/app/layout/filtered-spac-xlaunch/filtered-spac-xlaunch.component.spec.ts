...
import { FilteredSpacXlaunchComponent } from './filtered-spac-xlaunch.component';

describe('FilteredSpacXlaunchComponent', () => {
  let component: FilteredSpacXlaunchComponent;
  let fixture: ComponentFixture<FilteredSpacXlaunchComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ FilteredSpacXlaunchComponent ]
    })
    .compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(FilteredSpacXlaunchComponent);

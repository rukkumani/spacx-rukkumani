...
import { SpacXlaunchComponent } from './spac-xlaunch.component';
import {FilteredSpacXlaunchComponent} from '../filtered-spac-xlaunch/filtered-spac-xlaunch.component'
import { HttpService } from '../../services/http.service'

describe('SpacXlaunchComponent', () => {
  let component: SpacXlaunchComponent;
  let fixture: ComponentFixture<SpacXlaunchComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ SpacXlaunchComponent,FilteredSpacXlaunchComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(SpacXlaunchComponent);
  ...
  it('should render title in h4 tag', () => {
    ...
    expect(compiled.querySelector('h4').textContent).toContain('SpaceX Launch Programs')
  })
  
  it("should fetch data asynchronously", async () => {

    const quoteService = fixture.debugElement.injector.get(HttpService);
    let spy = spyOn(quoteService, "getspaceXlaunch").and.returnValue(of(
    ...
    fixture.whenStable().then(() => {
      expect(component.launchData).toBe(spy);
    }).catch(()=>{
      expect(component.launchData).toBeFalsy();
